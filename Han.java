...
public class Han extends AbstractGame {
    ...
    private static final String SPLASH_FILE = "assets/custom/Splash.jpg";
    private static final String BG_IMAGE = "assets/custom/bg.gif";
    ...
    public Han(int gameWidth, int gameHeight) {
    ...
    protected void preGame() {
        ...
        this.setSplashImage(SPLASH_FILE);
